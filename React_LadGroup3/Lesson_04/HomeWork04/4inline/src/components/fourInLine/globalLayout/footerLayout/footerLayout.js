...
class FooterLayout extends Component {
    ...
    isLinkActive = (e) => {
        if (!this.props.isGaming) e.preventDefault();
    }
    ...
    render() {
        ...
        <div className="rigth-column-footer">
                <div>
                    <a href="https://github.com/IgorBarbashov/React_LadGroup3" target="_blank" rel="noopener noreferrer">
                        <LogoGitHub
                            size="30"
                ...
                <div>
                    <a href="https://vk.com/igor_barbashov" target="_blank" rel="noopener noreferrer">
                        <LogoVK
                            size="30"
                ...
                <div>
                    <a href="https://www.facebook.com/Barbashov.Igor" target="_blank" rel="noopener noreferrer">
                        <LogoFB
                            size="30"
