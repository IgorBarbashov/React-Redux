...
class Smile extends Component {
    state = {
        ...
        smileStyle: "wellcome-footer-inner",
        smileStyleIn: "wellcome-footer-inner smile-mouse",
        smileStyleOut: "wellcome-footer-inner"
    }
    
    mouseEnternOnItem = () => {
        let newColor = "red";
        let newStyle = this.state.smileStyleIn;
        this.setState( {fillColor: newColor, smileStyle: newStyle});
    }
    mouseLeaveFromItem = () => {
        let newColor = "green";
        let newStyle = this.state.smileStyleOut;
        this.setState( {fillColor: newColor, smileStyle: newStyle});
    }

    render() {
        let smileSize = this.props.size + "px";

        return (
        <div
            className={this.state.smileStyle}
